        ...
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
                <div className="rounded-lg border border-white/10 bg-white/5 p-2.5">
                    <p className="text-[11px] text-slate-400">کد ملی</p>
                    <p className="font-medium text-white font-mono">{kyc.nationalCode || '—'}</p>
                </div>
                <div className="rounded-lg border border-white/10 bg-white/5 p-2.5">
                    <p className="text-[11px] text-slate-400">تاریخ تولد</p>
                    <p className="font-medium text-white">{kyc.birthDate || '—'}</p>
                </div>
                <div className="rounded-lg border border-white/10 bg-white/5 p-2.5">
                    <p className="text-[11px] text-slate-400">کد پستی</p>
                    <p className="font-medium text-white font-mono">{kyc.postalCode || '—'}</p>
                </div>
                <div className="rounded-lg border border-white/10 bg-white/5 p-2.5">
                    <p className="text-[11px] text-slate-400">آدرس سکونت</p>
                    <p className="font-medium text-white line-clamp-2" title={kyc.address}>{kyc.address || '—'}</p>
                </div>
            </div>
